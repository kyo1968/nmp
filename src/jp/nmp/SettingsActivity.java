...
public final class SettingsActivity extends PreferenceActivity { 
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (extDir != null) {
			extStorage.setSummaryOn(getString(R.string.perf_summary_external_storage, extDir.getAbsolutePath())); 
		} else {
		...
		if (intDir != null) {
			extStorage.setSummaryOff(getString(R.string.perf_summary_external_storage, intDir.getAbsolutePath()));
		}		
	}
}